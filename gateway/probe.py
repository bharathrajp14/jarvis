...
from gateway.client import get_proxy_brain_client
from gateway.discovery import get_discovery_service
from gateway.health import HealthState, get_health_service
