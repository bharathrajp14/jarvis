...
import pytest
from brjarvis.tools.registry import TOOL_REGISTRY, TOOL_SCHEMAS, register_tool, execute_tool, _import_plugins
...
def test_tool_registration_and_execution():
    ...
    @register_tool(name="calc_add_unit_test", description="Add two integers")
