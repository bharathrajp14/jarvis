...
class TestWhatsAppCalendarAutomation(unittest.TestCase):
    ...
    def test_02_whatsapp_messaging_and_scheduling(self):
        ...
        print(f"[Test] WhatsApp schedule output: {sched_res}")
    ...
    def test_03_calendar_natural_language_event_creation(self):
        ...
        print(f"[Test] Calendar Event Created: #{event_res['event_id']} '{event_res['title']}' on {event_res['start_time']}")
    ...
    def test_04_calendar_listing_and_searching(self):
        ...
        print(f"[Test] Calendar Search for 'Sync' found {len(search_matches)} matches.")
    ...
    def test_05_workflow_integration_whatsapp_calendar(self):
        ...
        print(f"[Test] Workflow script execution output: {res['results']}")
    ...
    def test_06_tool_registry_execution(self):
        ...
        print(f"[Test] Tool 'list_calendar_events' output:\n{out_cal}")
