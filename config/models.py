...
_DEFAULTS = {
    ...
    "gemini_code":      "gemini-3.5-flash-extra-low",
    "gemini_reasoning": "gemini-3.6-flash-medium",
    "gemini_general":   "gemini-3.5-flash-extra-low",
    "gemini_agent":     "gemini-3.5-flash-extra-low",
    "gemini_fast":      "gemini-3.5-flash-extra-low",
    "gemini_vision":    "gemini-3.1-flash-image",
    "gemini_lite":      "gemini-3.5-flash-extra-low",
    "claude":           "gemini-3.5-flash-extra-low",
    "gpt":              "gemini-3.5-flash-extra-low",
    "gpt_mini":         "gemini-3.5-flash-extra-low",
    "gpt_4o":           "gemini-3.6-flash-medium",
    "ollama":           "llama3.3",
    "nvidia":           "meta/llama-3.1-70b-instruct",
    "mistral":          "mistral-large-latest",
    "default_backend":  "gpt",
    "planner_model":    "gemini-3.5-flash-extra-low",
    "fast_model":       "gemini-3.5-flash-extra-low",
    "openai_base_url":  "http://localhost:8045/v1",
    "openai_api_key":   "sk-5ec70bf9fa324084b7a7326babf52c45",
    "openai_model":     "gemini-3.5-flash-extra-low",
}
