...
description: Scan codebases for technical debt, score severity, track trends, and
  ...
  Also use for legacy code modernization planning and maintenance cost estimation.
category: engineering
domain: Engineering
triggers:
- /tech-debt-tracker
- run tech debt tracker
...
- repo_controller
- file_processor
argument-hint: '[tech debt tracker details]'
when_to_use: Use when user requests tech debt tracker guidance or task execution.
user-invocable: true
context: inline
---
