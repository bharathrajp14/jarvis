...
_CANONICAL_MODELS: list[ModelSpec] = [
    ...
    ModelSpec(
        ...
        capabilities=frozenset(
            {
                TaskCapability.FAST_CHAT,
                TaskCapability.LOW_LATENCY,
                TaskCapability.SUMMARIZATION,
                TaskCapability.CLASSIFICATION,
                TaskCapability.EXTRACTION,
            }
        ),
        tier=ModelTier.LITE,
        speed="fast",
    ...
    ModelSpec(
        ...
        provider="google",
        family="gemini",
        capabilities=frozenset({TaskCapability.REASONING, TaskCapability.CODE, TaskCapability.PLANNING}),
        tier=ModelTier.PRO,
        speed="medium",
        context_class="large",
        tool_use=True,
    ...
    ModelSpec(
        ...
        provider="google",
        family="gemini",
        capabilities=frozenset({TaskCapability.VISION, TaskCapability.IMAGE, TaskCapability.CHAT}),
        tier=ModelTier.BALANCED,
        speed="medium",
        context_class="large",
        tool_use=True,
    ...
    ModelSpec(
        ...
        family="gemini",
        capabilities=frozenset(
            {TaskCapability.CHAT, TaskCapability.FAST_CHAT, TaskCapability.SUMMARIZATION, TaskCapability.TOOL_SELECTION}
        ),
        tier=ModelTier.BALANCED,
        speed="fast",
        context_class="large",
    ...
    ModelSpec(
        ...
        family="gemini",
        capabilities=frozenset(
            {TaskCapability.REASONING, TaskCapability.CODE, TaskCapability.PLANNING, TaskCapability.LONG_CONTEXT}
        ),
        tier=ModelTier.PRO,
        speed="medium",
        context_class="large",
    ...
    ModelSpec(
        ...
        provider="google",
        family="gemini",
        capabilities=frozenset({TaskCapability.CHAT, TaskCapability.FAST_CHAT, TaskCapability.SUMMARIZATION}),
        tier=ModelTier.BALANCED,
        speed="fast",
        context_class="standard",
        tool_use=True,
    ...
    ModelSpec(
        ...
        provider="google",
        family="gemini",
        capabilities=frozenset({TaskCapability.FAST_CHAT, TaskCapability.LOW_LATENCY, TaskCapability.CLASSIFICATION}),
        tier=ModelTier.LITE,
        speed="fast",
        context_class="standard",
        tool_use=True,
    ...
    ModelSpec(
        ...
        provider="google",
        family="gemini",
        capabilities=frozenset({TaskCapability.REASONING, TaskCapability.PLANNING, TaskCapability.CODE}),
        tier=ModelTier.PRO,
        speed="medium",
        context_class="large",
        tool_use=True,
    ...
    ModelSpec(
        ...
        family="gpt",
        capabilities=frozenset(
            {TaskCapability.CHAT, TaskCapability.REASONING, TaskCapability.CODE, TaskCapability.SUMMARIZATION}
        ),
        tier=ModelTier.BALANCED,
        speed="medium",
        context_class="large",
