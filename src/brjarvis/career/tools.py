...
@register_tool(
    ...
    parameters={
        "type": "object",
        "properties": {"profile_id": {"type": "string", "description": "Profile ID, defaults to master_profile"}},
    },
)
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            "updates": {
                "type": "object",
                "description": "Key-value dictionary of profile updates (e.g. {'contact.phone': '+91 99999', 'summary': 'New pitch'})",
            }
        },
        "required": ["updates"],
    },
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "template_id": {
                "type": "string",
                "description": "Template key name (e.g. 'ats_classic', 'technical_engineer', 'ai_data')",
            },
            "export_formats": {
                "type": "array",
                "items": {"type": "string"},
                "description": "List of formats to export ['docx', 'pdf', 'html']",
            },
        },
    },
)
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            "job_description": {
                "type": "string",
                "description": "Optional job description to evaluate keyword overlap against",
            },
...
@register_tool(
    ...
    parameters={
        "type": "object",
        "properties": {"job_id": {"type": "string", "description": "Job ID from search results"}},
        "required": ["job_id"],
    },
)
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "auto_open_browser": {
                "type": "boolean",
                "description": "Whether to launch browser application page (default True)",
            },
        },
        "required": ["job_id"],
    },
...
@register_tool(
    ...
    parameters={
        "type": "object",
        "properties": {"application_url": {"type": "string", "description": "URL of application page"}},
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            "status_filter": {
                "type": "string",
                "description": "Optional status filter (e.g. 'SHORTLISTED', 'SUBMITTED', 'INTERVIEW', 'OFFER')",
            }
        },
    },
)
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "new_status": {
                "type": "string",
                "description": "New status (SUBMITTED, INTERVIEW, TECHNICAL, OFFER, REJECTED, etc.)",
            },
...
@register_tool(
    ...
    parameters={
        "type": "object",
        "properties": {"job_id": {"type": "string", "description": "Job ID to generate interview preparation for"}},
        "required": ["job_id"],
    },
)
...
@register_tool(
    ...
    parameters={
        "type": "object",
        "properties": {"auto_open": {"type": "boolean", "description": "Whether to launch Excel after sync"}},
    },
)
...
register_tool(
    ...
    "Tailor resume bullets and export verified deliverables",
    {"type": "object", "properties": {"job_description": {"type": "string"}}, "required": ["job_description"]},
)(resume_tailor_tool)
register_tool(
    "career_resume_build",
    "Build and render master resume",
    {"type": "object", "properties": {"target_role": {"type": "string"}}},
)(resume_create_tool)
register_tool(
    "career_job_search",
    "Search live postings across Greenhouse, Lever, Ashby",
    {"type": "object", "properties": {"query": {"type": "string"}}},
)(job_search_tool)
register_tool(
    "career_job_match",
    "Score and rank candidate fit against job description",
    {"type": "object", "properties": {"job_id": {"type": "string"}}, "required": ["job_id"]},
)(job_details_tool)
register_tool(
    "career_ats_evaluate",
    "Run 7-factor deterministic ATS compliance scoring",
    {"type": "object", "properties": {"job_description": {"type": "string"}}},
)(ats_score_resume_tool)
register_tool(
    "career_cover_letter_generate",
    "Generate tailored cover letter in text and PDF",
    {"type": "object", "properties": {"job_description": {"type": "string"}}, "required": ["job_description"]},
)(cover_letter_generate_tool)
register_tool(
    "career_application_prepare",
    "Generate application package and open job portal",
    {"type": "object", "properties": {"job_id": {"type": "string"}}, "required": ["job_id"]},
)(application_prepare_tool)
register_tool(
    "career_application_submit",
    "Record application submission",
    {"type": "object", "properties": {"application_id": {"type": "string"}}, "required": ["application_id"]},
)(application_status_update_tool)
register_tool(
    "career_application_verify",
    "Verify physical application artifacts",
    {"type": "object", "properties": {"application_id": {"type": "string"}}, "required": ["application_id"]},
)(application_status_update_tool)
register_tool(
    "career_application_track",
    "Update application status in state machine",
    {"type": "object", "properties": {"application_id": {"type": "string"}}},
)(application_track_list_tool)
register_tool(
    "career_interview_prep",
    "Generate customized technical interview prep kit",
    {"type": "object", "properties": {"interview_id": {"type": "string"}}},
)(interview_prep_generate_tool)
register_tool(
    "career_analytics_report", "Calculate career funnel conversion metrics", {"type": "object", "properties": {}}
)(career_analytics_summary_tool)
register_tool(
    "career_followup_draft",
    "Generate follow-up message draft",
    {"type": "object", "properties": {"followup_id": {"type": "string"}}, "required": ["followup_id"]},
)(career_followup_generate_draft_tool)
register_tool("career_learning_report", "Analyze historical learning insights", {"type": "object", "properties": {}})(
    career_learning_insights_tool
)
register_tool(
    "career_email_analyze",
    "Process and classify incoming career emails",
    {
        "type": "object",
        "properties": {"sender": {"type": "string"}, "subject": {"type": "string"}, "body": {"type": "string"}},
        "required": ["sender", "subject", "body"],
    },
)(career_email_process_tool)
