...
from .models import SectionConfig, TemplateType, ThemeConfig
...
def _standard_sections() -> List[SectionConfig]:
    return [
        ...
        SectionConfig(
            section_id="experience", title="Professional Experience", visible=True, order=3, layout="standard"
        ),
        SectionConfig(
            section_id="projects", title="Featured Engineering Projects", visible=True, order=4, layout="standard"
        ),
        SectionConfig(
            section_id="education", title="Education & Academic Background", visible=True, order=5, layout="standard"
        ),
        SectionConfig(
            section_id="certifications", title="Certifications & Credentials", visible=True, order=6, layout="standard"
        ),
        SectionConfig(
            section_id="achievements", title="Honors & Achievements", visible=True, order=7, layout="standard"
        ),
    ]
...
TEMPLATES: Dict[TemplateType, TemplateDefinition] = {
    ...
    TemplateType.FRESH_GRADUATE: TemplateDefinition(
        ...
        default_sections=[
            ...
            SectionConfig(
                section_id="skills", title="Technical Skills & Proficiencies", visible=True, order=3, layout="pills"
            ),
            SectionConfig(
                section_id="projects",
                title="Academic & Personal Engineering Projects",
                visible=True,
                order=4,
                layout="standard",
            ),
            ...
            SectionConfig(
                section_id="certifications", title="Certifications & Training", visible=True, order=6, layout="standard"
            ),
            SectionConfig(
                section_id="achievements",
                title="Extracurricular & Academic Honors",
                visible=True,
                order=7,
                layout="standard",
            ),
    ...
    TemplateType.AI_DATA: TemplateDefinition(
        ...
        default_sections=[
            SectionConfig(
                section_id="summary", title="AI Systems & Research Summary", visible=True, order=1, layout="standard"
            ),
            SectionConfig(
                section_id="skills", title="AI/ML Models, Frameworks & Tooling", visible=True, order=2, layout="grid"
            ),
            SectionConfig(
                section_id="experience",
            ...
            SectionConfig(
                section_id="projects",
                title="Featured Autonomous Systems & ML Projects",
                visible=True,
                order=4,
                layout="standard",
            ),
            SectionConfig(
                ...
                title="AI Certifications & Specialized Credentials",
                visible=True,
                order=5,
                layout="standard",
            ),
            SectionConfig(
                section_id="education",
                title="Academic Background in Computing & AI",
                visible=True,
                order=6,
                layout="standard",
            ),
            SectionConfig(
                section_id="achievements",
                title="Research, Hackathons & Benchmark Honors",
                visible=True,
                order=7,
                layout="standard",
            ),
    ...
    TemplateType.CYBERSECURITY: TemplateDefinition(
        ...
        default_sections=[
            SectionConfig(
                section_id="summary",
                title="Security Profile & Threat Posture",
                visible=True,
                order=1,
                layout="standard",
            ),
            SectionConfig(
                section_id="certifications",
                title="Security Credentials & Certifications",
                visible=True,
                order=2,
                layout="standard",
            ),
            SectionConfig(
                section_id="skills",
                title="Security Tooling & Defense Capabilities",
                visible=True,
                order=3,
                layout="pills",
            ),
            SectionConfig(
                section_id="experience",
                title="Security Engineering & Defense Experience",
                visible=True,
                order=4,
                layout="standard",
            ),
            SectionConfig(
                section_id="projects",
                title="Security Audits & Infrastructure Hardening",
                visible=True,
                order=5,
                layout="standard",
            ),
            ...
            SectionConfig(
                section_id="achievements",
                title="CVE Disclosures & Security Honors",
                visible=True,
                order=7,
                layout="standard",
            ),
