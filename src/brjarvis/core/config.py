...
class ModelConfig(BaseModel):
    ...
    gemini: str = Field(default="gemini-3-flash-agent", description="Gemini model ID")
    gemini_code: str = Field(default="gemini-3-flash-agent", description="Gemini Code model ID")
    gemini_reasoning: str = Field(default="gemini-3-flash-agent", description="Gemini Reasoning model ID")
    claude: str = Field(default="gemini-3-flash-agent", description="Claude model ID")
    gpt: str = Field(default="gemini-3-flash-agent", description="GPT model ID")
