...
_PRO_SKILLS = [
    ...
    ("code_review", "Thorough code review with severity levels", ["/code-review", "/review-code", "/cr"],
     ["file_read", "web_search", "run_code"], _CODE_REVIEW, "reviewing code quality"),
    ("refactor", "Refactor code without changing behavior", ["/refactor", "/cleanup"],
     ["file_read", "file_write", "code_refactor", "run_code"], _REFACTOR, "improving code quality"),
    ...
    ("git_flow", "Git branch management and workflow", ["/git-flow", "/git"],
     ["git_repo_mgr", "run_code"], _GIT_FLOW, "git operations"),
    ("dep_audit", "Audit project dependencies for vulnerabilities", ["/dep-audit", "/audit-deps"],
     ["file_read", "run_code", "web_search", "dependency_diagnostics"], _DEPENDENCY_AUDIT, "auditing dependencies"),

    # Security
    ("security_scan", "Automated security scanning", ["/security-scan", "/sec-scan"],
     ["audit_prompt_security", "audit_codebase", "run_code", "fetch_raw", "file_read"], _SECURITY_SCAN, "security scanning"),
    ...
    ("ssl_check", "SSL/TLS certificate security audit", ["/ssl-check", "/ssl"],
     ["run_code", "fetch_raw", "headers_audit"], _SSL_CHECK, "checking SSL certificates"),
    ("hash_lookup", "File hash calculation and lookup", ["/hash", "/hash-lookup"],
     ["run_code", "web_search", "file_read", "native_hash_fast"], _HASH_LOOKUP, "analyzing file hashes"),
    ...
    ("csv_analysis", "Analyze CSV/JSON data files", ["/csv-analysis", "/data-analysis", "/analyze-data"],
     ["file_read", "run_code", "analyze_project_to_excel"], _CSV_ANALYSIS, "analyzing data files"),
    ...
    ("chart_gen", "Generate charts from data", ["/chart", "/chart-gen", "/plot"],
     ["run_code", "file_read", "file_write", "create_excel_sheet"], _CHART_GEN, "generating charts"),
    ("web_scraper_pro", "Extract data using HTML parsing and headless browser", ["/scrape", "/web-extract"],
     ["browser_auto_navigate_and_extract", "fetch_page", "file_write"], _WEB_SCRAPER_PRO, "scraping websites"),
    ("database_migration", "Design database schema migration scripts", ["/db-migrate", "/migration"],
     ["file_write", "file_read", "run_code"], _DATABASE_MIGRATION, "database migrations"),
    ...
    ("performance_profile", "Profile CPU and memory performance bottlenecks", ["/profile", "/perf"],
     ["run_code", "file_read", "runtime_diagnostics"], _PERFORMANCE_PROFILE, "performance profiling"),
    ("async_conversion", "Refactor synchronous code to async/await", ["/async-convert", "/asyncio"],
     ["file_read", "file_write", "code_refactor"], _ASYNC_CONVERSION, "async code conversion"),
    ...
    ("cloud_architecture", "Design cloud infrastructure solution architectures", ["/cloud-arch", "/cloud-design"],
     ["file_write", "document_creator"], _CLOUD_ARCH, "cloud architecture design"),

    # Productivity
    ("doc_gen", "Generate technical documentation", ["/doc-gen", "/docs", "/generate-docs"],
     ["document_creator", "file_read", "file_write"], _DOC_GEN, "generating documentation"),
    ...
    ("meeting_notes", "Structure meeting notes and action items", ["/meeting-notes", "/notes"],
     ["file_read", "file_write", "document_creator"], _MEETING_NOTES, "structuring meeting notes"),
    ("email_draft", "Draft professional emails", ["/email", "/draft-email"],
     ["send_email", "gmail_send", "file_write"], _EMAIL_DRAFT, "drafting emails"),

    # System Admin
    ("system_info", "System diagnostics and health report", ["/system-info", "/sysinfo"],
     ["get_system_diagnostics", "system_diagnostic", "system_health", "run_code"], _SYSTEM_INFO, "gathering system info"),
    ("process_mgr", "Process management and monitoring", ["/process", "/ps"],
     ["get_system_diagnostics", "kill_process", "run_code"], _PROCESS_MANAGER, "managing processes"),
    ("network_diag", "Network diagnostics and troubleshooting", ["/network-diag", "/netdiag", "/ping"],
     ["run_code", "port_scan", "nmap_scan", "dns_enum"], _NETWORK_DIAG, "network diagnostics"),
    ("disk_cleanup", "Disk space analysis and cleanup suggestions", ["/disk-cleanup", "/disk"],
     ["system_cleanup", "get_system_diagnostics", "run_code"], _DISK_CLEANUP, "analyzing disk space"),
    ("cron_scheduler", "Create scheduled tasks and cron jobs", ["/cron", "/schedule"],
     ["scheduler", "run_code", "file_write"], _CRON_SCHEDULER, "scheduling tasks"),
]
