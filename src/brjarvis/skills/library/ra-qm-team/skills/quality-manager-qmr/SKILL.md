...
description: Senior Quality Manager Responsible Person (QMR) for HealthTech and MedTech
  ...
  Use when leading management reviews, setting quality policy and objectives, monitoring
  quality KPIs and cost of quality, or exercising QMR governance and regulatory oversight
  responsibilities.
category: ra-qm-team
domain: Ra Qm Team
triggers:
...
- rag_query
- batch_file_ops
argument-hint: '[quality manager qmr details]'
when_to_use: Use when user requests quality manager qmr guidance or task execution.
user-invocable: true
context: inline
---
