...
description: 'Curate Claude Code''s auto-memory into durable project knowledge. Analyze
  ...
  has learned about your project, (2) graduating a pattern from notes to enforced
  rules, (3) turning a debugging solution into a skill, (4) checking memory health
  and capacity.'
...
- git_repo_mgr
- batch_file_ops
argument-hint: '[self improving agent details]'
when_to_use: Use when user requests self improving agent guidance or task execution.
user-invocable: true
context: inline
---
