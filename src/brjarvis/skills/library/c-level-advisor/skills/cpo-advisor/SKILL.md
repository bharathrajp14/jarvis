...
description: Product leadership for scaling companies. Product vision, portfolio strategy,
  ...
  portfolio level, reporting to the board on product, or when user mentions CPO, product
  strategy, product-market fit, product organization, portfolio prioritization, or
  roadmap strategy.
...
- web_search
- rag_query
argument-hint: '[cpo advisor details]'
when_to_use: Use when user requests cpo advisor guidance or task execution.
user-invocable: true
context: inline
---
