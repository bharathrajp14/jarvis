...
def get_pending_channel_actions_action(args: Dict[str, Any]) -> str:
    ...
    listener = get_proactive_listener()
    return json.dumps({"status": listener.get_status(), "pending_actions": listener.pending_actions}, indent=2)
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "event_date": {
                "type": "string",
                "description": "Optional date string for calendar event (e.g., 'tomorrow')",
            },
            "event_time": {
                "type": "string",
                "description": "Optional time string for calendar event (e.g., '3:00 PM')",
            },
        },
