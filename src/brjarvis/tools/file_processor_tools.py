...
from brjarvis.actions.file_processor import file_processor
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "action": {
                "type": "string",
                "description": "Action to perform: 'summarize', 'ocr', 'describe', 'convert', 'analyze', 'extract_text', 'resize', 'info'.",
            },
