"""
ProactiveEngine 2.0 — context-aware, time-aware, non-repetitive background prompting for BR JARVIS.
...
class ProactiveEngine:
    ...
    def build_prompt(
        ...
        """
        Build a context snapshot for LLM.
